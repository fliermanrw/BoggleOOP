...
public class BoggleModel {
    ...
    public HashSet<String> newWordList() throws IOException {
        ...
        // ENGLISH DICT RYAN : C:/Users/Ryan/IdeaProjects/blok13/BoggleOOP/src/english-dict.txt
        Scanner sc = new Scanner(new File("C:/Users/Ryan/IdeaProjects/blok13/BoggleOOP/src/english-dict.txt"));
        while(sc.hasNext()){
